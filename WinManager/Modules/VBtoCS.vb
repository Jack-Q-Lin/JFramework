Module VBtoCS
    Sub VBtoCS_Quoted_Strings_Get(ByRef cLine As String, ByRef aSubStr As String, ByRef nSubStrCount As Integer)
    ...
    Sub VBtoCS_Quoted_Strings_Set(ByRef cLine As String, ByRef aSubStr As String)
        Dim nP1, nP2 As Integer
        Dim cID As String
    ...
    Function VBtoCS_Type(ByVal sType) As String
    ...
    Sub VBtoCS_VariableDefine(ByVal cLeftBlank As String, ByRef cVarDefs As String, ByRef aSubStrInQuotes As String, ByRef aArrayDefines As String, ByRef outCSFile As Object)
        ' cVarDefs can be:
        ...
        Do While Len(cVarDefs) > 1
            ...
            If InStr(aVars, "(") Then      ' Array
                ...
                Do While Len(aVars) > 1
                    ...
                    If InStr(aVar, "(") Then      ' Array
                        ...
                        Call VBtoCS_Quoted_Strings_Set(aVar, aSubStrInQuotes)
            ...
            Else
                ...
                Call VBtoCS_Quoted_Strings_Set(aVars, aSubStrInQuotes)
    ...
    Function VBtoCS_ArrayReQuote(ByVal cExpression As String, ByVal aArrayDefines As String) As String
        ...
        VBtoCS_ArrayReQuote = cExpression

    End Function

    Function VBtoCS_ConvertExpresion(ByVal cExpression As String, ByVal aArrayDefines As String, ByVal cWith As String) As String
        Dim cVName As String
        Dim nP, i, j, nQuotes As Integer
        ...
        VBtoCS_ConvertExpresion = VBtoCS_ArrayReQuote(cExpression, aArrayDefines)

    End Function

    Sub VBtoCS_CommonStatements(ByVal cLeftBlank As String, ByRef cExpression As String, ByRef aSubStr As String, ByVal aArrayDefines As String, ByVal cWith As String, ByRef outCSFile As Object)
        cExpression = Replace(" " + cExpression, " .", " " + cWith + ".")
        cExpression = VBtoCS_ArrayReQuote(cExpression, aArrayDefines)

        Call VBtoCS_Quoted_Strings_Set(cExpression, aSubStr)
        outCSFile.WriteLine(cLeftBlank + cExpression + ";")

    End Sub

    Sub VBtoCS_TextFile_To_TextFile()
        ...
        Do While inVBAFile.AtEndOfStream <> True
            ...
            Call VBtoCS_Quoted_Strings_Get(cLineString, aSubStrInQuotes, nP)

            ' === Remove comments
            nP1 = InStr(cLineString, "'")
            If nP1 > 0 Then
                cLineStringCS = MID(cLineString, nP1 + 1)
                Call VBtoCS_Quoted_Strings_Set(cLineStringCS, aSubStrInQuotes)
            ...
            Do While Right(cLineString, 1) = "_" And inVBAFile.AtEndOfStream <> True
                ...
                Call VBtoCS_Quoted_Strings_Get(cContinueLineString, aSubStrInQuotes, nP)
            ...
            If lContinue Then
                ...
                If nP > 0 Then
                    ...
                    Else
                        ...
                        Call VBtoCS_VariableDefine(cLeftSpaces + "      ", cParameterDefines, aSubStrInQuotes, aArrayDefines, outCSFile)
            ...
            If lContinue Then
                ...
                If nP > 0 Then
                    ...
                    cReturnType = VBtoCS_Type(Trim(MID(cLineString, nP + 5)))
            ...
            If lContinue Then
                If Left(cLineString, 4) = "Dim " Or Left(cLineString, 6) = "Const " Or Left(cLineString, 9) = "ReadOnly " Then
                    Call VBtoCS_VariableDefine(cLeftSpaces, cLineString, aSubStrInQuotes, aArrayDefines, outCSFile)
            ...
            If lContinue Then
                If Left(cLineString, 3) = "If " Then
                    ...
                    cLineStringCS = "if (" + VBtoCS_ConvertExpresion(MID(cLineString, 4, nP - 4), aArrayDefines, aWith(nWith - 1)) + ") {"
                    Call VBtoCS_Quoted_Strings_Set(cLineStringCS, aSubStrInQuotes)
                    outCSFile.WriteLine(cLeftSpaces + cLineStringCS)
                    ...
                    Else
                        ...
                        If nP > 0 Then
                            ...
                            Call VBtoCS_CommonStatements(cLeftSpaces, cLineStringCS, aSubStrInQuotes, aArrayDefines, aWith(nWith - 1), outCSFile)
            ...
            If lContinue Then
                If Left(cLineString, 7) = "ElseIf " Then
                    ...
                    If nP = Len(cLineString) - 4 Then
                        cLineStringCS = "} else if (" + VBtoCS_ConvertExpresion(MID(cLineString, 8, nP - 8), aArrayDefines, aWith(nWith - 1)) + ") {"
                    Else
                        cLineStringCS = "} else if (" + VBtoCS_ConvertExpresion(MID(cLineString, 8, nP - 8), aArrayDefines, aWith(nWith - 1)) + ") {" + MID(cLineString, nP + 5) + ";}"
                    End If
            ...
            If lContinue Then
                If Left(cLineString, 12) = "Select Case " Then
                    cLineStringCS = "switch (" + VBtoCS_ConvertExpresion(MID(cLineString, 13), aArrayDefines, aWith(nWith - 1)) + ") {"
            ...
            If lContinue Then
                If Left(cLineString, 5) = "Case " Then
                    ...
                    nP = InStr(cLineString, ",")
                    Do While nP > 0
                        cLineStringCS = "case " + VBtoCS_ConvertExpresion(Left(cLineString, nP - 1), aArrayDefines, aWith(nWith - 1)) + ":"
                    ...
                    cLineStringCS = "case " + VBtoCS_ConvertExpresion(cLineString, aArrayDefines, aWith(nWith - 1)) + ":"
            ...
            If lContinue Then
                ...
                If Left(cLineString, 6) = "While " Then
                    cLineStringCS = "while (" + VBtoCS_ConvertExpresion(MID(cLineString, 7), aArrayDefines, aWith(nWith - 1)) + ") {"
                ElseIf Left(cLineString, 9) = "Do While " Then
                    cLineStringCS = "while (" + VBtoCS_ConvertExpresion(MID(cLineString, 10), aArrayDefines, aWith(nWith - 1)) + ") {"
            ...
            If lContinue Then
                ...
                If Left(cLineString, 11) = "Loop While " Then
                    cLineStringCS = "while (" + VBtoCS_ConvertExpresion(MID(cLineString, 12), aArrayDefines, aWith(nWith - 1)) + ");"
            ...
            If lContinue Then
                ...
                ElseIf Left(cLineString, 4) = "For " Then
                    ...
                    If nP2 > 0 Then
                        cLineStringCS = VBtoCS_ConvertExpresion(MID(cLineString, nP1 + 4, nP2 - nP1 - 4), aArrayDefines, aWith(nWith - 1))
                    ...
                    Else
                        cLineStringCS = VBtoCS_ConvertExpresion(MID(cLineString, nP1 + 4), aArrayDefines, aWith(nWith - 1))
            ...
            If lContinue Then
                If Left(cLineString, 5) = "With " Then
                    cLineStringCS = VBtoCS_ConvertExpresion(Trim(MID(cLineString, 6)), aArrayDefines, aWith(nWith - 1))
                    Call VBtoCS_Quoted_Strings_Set(cLineStringCS, aSubStrInQuotes)
